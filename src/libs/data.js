...
class Data extends DataGeneric {
 ...
 async createDB() {
  try {
   ...
   await this.db.query('CREATE TABLE IF NOT EXISTS admins_logins (id INT PRIMARY KEY AUTO_INCREMENT, id_admins INT, session VARCHAR(128) NULL, created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (id_admins) REFERENCES admins(id))');
   await this.db.query('CREATE TABLE IF NOT EXISTS admins_sessions (id INT PRIMARY KEY AUTO_INCREMENT, id_admins INT, session VARCHAR(255) NOT NULL UNIQUE, last TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (id_admins) REFERENCES admins(id))');
   await this.db.query('CREATE TABLE IF NOT EXISTS domains (id INT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(255) NOT NULL UNIQUE, created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)');
...
//await this.db.query('CREATE TABLE IF NOT EXISTS logs (id INT PRIMARY KEY AUTO_INCREMENT, level INT NOT NULL, topic VARCHAR(32) NOT NULL, message TEXT NULL, params TEXT NULL, created TIMESTAMP DEFAULT CURRENT_TIMESTAMP)');
   await this.db.query('CREATE TABLE IF NOT EXISTS logs (id INT PRIMARY KEY AUTO_INCREMENT, level INT NOT NULL, message TEXT NULL, params JSON NULL, created TIMESTAMP DEFAULT CURRENT_TIMESTAMP)');
  } catch (ex) {
